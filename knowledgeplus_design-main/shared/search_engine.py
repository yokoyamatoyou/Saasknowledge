...
try:
    ...
    logging.warning(f"NLTK stopwords import failed: {e}")
...
_stop_words_set: set[str] = set()
FALLBACK_STOPWORDS = ["this", "is", "a", "the"]
if stopwords is not None:
    try:
        _stop_words_set.update(stopwords.words("english"))
    except Exception as e_stop:
        logger.warning(f"Using fallback English stopwords: {e_stop}")
        _stop_words_set.update(FALLBACK_STOPWORDS)
else:
    _stop_words_set.update(FALLBACK_STOPWORDS)
